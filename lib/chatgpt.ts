import { ChatCompletionMessageToolCall } from 'https://deno.land/x/openai@v4.33.0/resources/chat/mod.ts'
import { FunctionDefinition } from 'https://deno.land/x/openai@v4.33.0/resources/shared.ts'
...
export async function callFunction(
  function_call: ChatCompletionMessageToolCall.Function,
): Promise<any> {
